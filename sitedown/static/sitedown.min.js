...
q?(a.params=d.params,b.copy(a.params,g),c.$broadcast("$routeUpdate",a)):(d||a)&&(r=!1,(s.current=d)&&d.redirectTo&&(b.isString(d.redirectTo)?e.path(o(d.redirectTo,d.params)).search(d.params).replace():e.url(d.redirectTo(d.pathParams,e.path(),e.search())).replace()),h.when(d).then(function(){if(d){var a,c,e=b.extend({},d.resolve);return b.forEach(e,function(a,c){e[c]=b.isString(a)?i.get(a):i.invoke(a,null,null,c)}),b.isDefined(a=d.template)?b.isFunction(a)&&(a=a(d.params)):b.isDefined(c=d.templateUrl)&&(b.isFunction(c)&&(c=c(d.params)),c=k.getTrustedResourceUrl(c),b.isDefined(c)&&(d.loadedTemplateUrl=c,a=j(c))),b.isDefined(a)&&(e.$template=a),h.all(e)}}).then(function(e){d==s.current&&(d&&(d.locals=e,b.copy(d.params,g)),c.$broadcast("$routeChangeSuccess",d,a))},function(b){d==s.current&&c.$broadcast("$routeChangeError",d,a,b)}))}function n(){var c,f;return b.forEach(d,function(d,g){var h;if(h=!f){var i=e.path();h=d.keys;var j={};if(d.regexp)if(i=d.regexp.exec(i)){for(var k=1,l=i.length;l>k;++k){var m=h[k-1],n=i[k];m&&n&&(j[m.name]=n)}h=j}else h=null;else h=null;h=c=h}h&&(f=a(d,{params:b.extend({},e.search(),c),pathParams:c}),f.$$route=d)}),f||d[null]&&a(d[null],{params:{},pathParams:{}})}function o(a,c){var d=[];return b.forEach((a||"").split(":"),function(a,b){if(0===b)d.push(a);else{var e=a.match(/(\w+)(?:[?*])?(.*)/),f=e[1];d.push(c[f]),d.push(e[2]||""),delete c[f]}}),d.join("")}var p,q,r=!1,s={routes:d,reload:function(){r=!0,c.$evalAsync(function(){l(),m()})},updateParams:function(a){if(!this.current||!this.current.$$route)throw f("norout");a=b.extend({},this.current.params,a),e.path(o(this.current.$$route.originalPath,a)),e.search(a)}};return c.$on("$locationChangeStart",l),c.$on("$locationChangeSuccess",m),s}]});var f=b.$$minErr("ngRoute");a.provider("$routeParams",function(){this.$get=function(){return{}}}),a.directive("ngView",d),a.directive("ngView",e),d.$inject=["$route","$anchorScroll","$animate"],e.$inject=["$compile","$controller","$route"]}(window,window.angular);var sitedown=angular.module("sitedown",["sitedown.routing","sitedown.templates","sitedown.controllers","sitedown.directives","sitedown.services","ngCookies"]).config(["$httpProvider",function(a){a.defaults.headers.post["Content-Type"]="application/x-www-form-urlencoded"}]).run(["$http","$cookies",function(a,b){a.defaults.headers.post["X-CSRFToken"]=b.csrftoken}]);angular.module("sitedown.routing",["ngRoute"]),angular.module("sitedown.controllers",[]),angular.module("sitedown.directives",[]),angular.module("sitedown.services",[]),angular.module("sitedown.templates",["_pages/sitedown/sitedown.html"]),angular.module("_pages/sitedown/sitedown.html",[]).run(["$templateCache",function(a){a.put("_pages/sitedown/sitedown.html",'<div class="site-wrapper">\n    <div class="site-wrapper-inner">\n        <div class="cover-container">\n\n            <div class="masthead clearfix">\n                <div class="inner">\n                    <h3 class="masthead-brand">Lolcomp</h3>\n                    <nav>\n                        <ul class="nav masthead-nav">\n                            <li><a href="https://www.reddit.com/r/lolcomp/"\n                                   target="_blank"><span class="icon-reddit"></span> Reddit</a></li>\n                            <li><a href="https://github.com/code-wukong/lolcomp"\n                                   target="_blank"><span class="icon-github"></span> Github</a></li>\n                            <li><a href="mailto:admin@lolcomp.net"><span class="icon-mail"></span> Contact</a></li>\n                        </ul>\n                    </nav>\n                </div>\n            </div>\n\n            <div class="inner cover">\n                <img class="image_codewukong_sitedown"\n                     ng-src="{{static.get_url(\'img/codewukong_sitedown.png\')}}"\n                     alt="The Website is Down" />\n                <p class="lead">Know your counters. Know your power spikes. Win.</p>\n                <p class="lead">\n                    <a class="btn btn-lg btn-default"\n                       href="https://www.reddit.com/r/lolcomp/"\n                       target="_blank">Learn more</a>\n                </p>\n            </div>\n\n            <div class="mastfoot">\n                <div class="inner">\n                    <p>©{{static.get_year()}} <a href="http://lolcomp.com">lolcomp.net</a>, by <a href="http://markanthonyserrano.com/"\n                                                                                                  target="_blank">Mark Anthony Serrano</a>.</p>\n                </div>\n            </div>\n\n        </div>\n    </div>\n</div>')}]),angular.module("sitedown.routing").config(["$routeProvider","$locationProvider",function(a,b){a.when("/",{templateUrl:"_pages/sitedown/sitedown.html"}).otherwise({redirectTo:"/"}),b.html5Mode(!0)}]),angular.module("sitedown.controllers").controller("ParentCtrl",["$scope","LcComms",function(a,b){var c;b.call_ws("ws/cst_sitedown",{test:null}).then(function(b){c=a.cst=b,d(),console.log({jarvan:b.jarvan})})["catch"](function(a){console.log(a,"catch")});var d=function(){a["static"]={get_url:function(a){return c.static_url+"/static/"+a},get_year:function(){var a=new Date;return a.getFullYear()}}}}]),angular.module("sitedown.services").factory("LcComms",["$http","$q",function(a,b){var c={call_ws:function(c,d){var e=b.defer();return a({url:c,method:"POST",data:d}).success(function(a){e.resolve(a)}).error(function(a){e.reject(a)}),e.promise}};return c}]);