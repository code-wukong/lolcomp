...
angular.module('internal.templates', ['_pages/champs/champs.html', '_pages/relations/relations.html', '_pages/rules/rules.html', 'lcEditRelObjType/lcEditRelObjType.html', 'lcLed/lcLed.html', 'lcPanel/lcPanel.html']);

angular.module("_pages/champs/champs.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("_pages/champs/champs.html",
    "<md-content flex>\n" +
...
angular.module("_pages/relations/relations.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("_pages/relations/relations.html",
    "<md-content flex>\n" +
    "    <md-toolbar class=\"md-theme-primary champs-content-toolbar\">\n" +
...
angular.module("_pages/rules/rules.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("_pages/rules/rules.html",
    "<md-content flex>\n" +
    "    <md-toolbar class=\"md-theme-primary champs-content-toolbar\">\n" +
...
angular.module("lcEditRelObjType/lcEditRelObjType.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("lcEditRelObjType/lcEditRelObjType.html",
    "<div layout=\"column\">\n" +
...
angular.module("lcLed/lcLed.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("lcLed/lcLed.html",
    "<div class=\"led\"></div>");
}]);

angular.module("lcPanel/lcPanel.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("lcPanel/lcPanel.html",
    "<div class=\"lc-panel-container md-whiteframe-z1\">\n" +
